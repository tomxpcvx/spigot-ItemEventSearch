...
public class ConfigUtil {
    ...
    private static void saveDefaultConfig() {
        ...
        configConfig.addDefault("ItemEventSearch.Scoreboard.EventItemFind", "&b&oGefundene:");
        configConfig.addDefault("ItemEventSearch.Scoreboard.EventItemExist", "&b&oVersteckte:");
        configConfig.addDefault("ItemEventSearch.Message.CommandGiveEventItem", "Du hast 64 Event-Items erhalten.");
        configConfig.addDefault("ItemEventSearch.Message.CommandGiveWrongWorld", "In dieser Welt kannst du diesen Befehl nicht nutzen.");
        configConfig.addDefault("ItemEventSearch.Message.CommandWorldSet", "Du hast die Event-Welt auf &c@WORLD &fgesetzt.");
        configConfig.addDefault("ItemEventSearch.Message.CommandPrizeSet", "Du hast die Event-Belohnung auf &c@MONEY &fgesetzt.");
        configConfig.addDefault("ItemEventSearch.Message.CommandWinners", "Folgende Spieler haben alle Event-Items gefunden:");
        configConfig.addDefault("ItemEventSearch.Message.CommandWinnersPrefixPlayerNames", "&b - ");
        configConfig.addDefault("ItemEventSearch.Message.CommandRemoveEnabled", "Du kannst nun Event-Items entfernen.");
        configConfig.addDefault("ItemEventSearch.Message.CommandRemoveDisabled", "Du kannst nun keine Event-Items mehr entfernen.");
        configConfig.addDefault("ItemEventSearch.Message.CommandNotFound", "Dieses Kommando existiert nicht.");
        configConfig.addDefault("ItemEventSearch.Message.RemovedEventItem", "Du hast Event-Item &c@NR &bentfernt.");
        configConfig.addDefault("ItemEventSearch.Message.PickupEventItem", "Du hast Event-Item &c@NR&b gefunden!");
        configConfig.addDefault("ItemEventSearch.Message.EventItemDrop", "Du hast Event-Item Nr. &c@NR&b plaziert!");
        configConfig.addDefault("ItemEventSearch.Message.EventItemPickUp1", "Du hast dein &c@NRtes &bEvent-Item gefunden.");
        configConfig.addDefault("ItemEventSearch.Message.EventItemPickUp2", "Du hast nun &c@NR &bvon &c@MAX &bEvent-Items.");
        configConfig.addDefault("ItemEventSearch.Message.Already", "Du hast dieses Event-Item bereits gefunden.");
        configConfig.addDefault("ItemEventSearch.Message.Win", "Du hast alle Event-Items gefunden!");
        configConfig.addDefault("ItemEventSearch.Message.WinMoney", "Du hast alle Event-Items gefunden! Als Belohnung erhältst du &c@money &bGeld.");
